...
namespace Izzy_Moonbot.Modules
{
    ...
    public class InfoModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task AboutCommandAsync()
        {
            ...
            await ReplyAsync($"Izzy Moonbot{Environment.NewLine}Programmed in C# with Virtual Studio and JetBrains Rider{Environment.NewLine}Programmed by Dr. Romulus#4444 and Cloudburst#0001 (Twi/Leah){Environment.NewLine}Supervisor programmed by MinteckPony#2245{Environment.NewLine}{Environment.NewLine}Profile picture by confetticakez#7352 (Confetti){Environment.NewLine}https://manebooru.art/images/4023149",
