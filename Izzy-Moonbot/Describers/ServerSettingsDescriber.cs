...
{
    private readonly Dictionary<string, ServerSettingsItem> _settings = new();

    public ServerSettingsDescriber()
    {
        // Core settings
        _settings.Add("Prefix",
            new ServerSettingsItem(SettingsItemType.Char, "The prefix I will listen to for commands.",
                SettingsItemCategory.Core));
        _settings.Add("SafeMode",
            new ServerSettingsItem(SettingsItemType.Boolean,
        ...
        _settings.Add("BatchSendLogs",
            new ServerSettingsItem(SettingsItemType.Boolean,
                ...
                SettingsItemCategory.Core));
        _settings.Add("BatchLogsSendRate",
            new ServerSettingsItem(SettingsItemType.Double, "The amount of seconds between each batch send.",
                SettingsItemCategory.Core));
        _settings.Add("IgnoredChannels",
            new ServerSettingsItem(SettingsItemType.ChannelList, "A list of channels I will ignore commands from.",
                SettingsItemCategory.Core));
        _settings.Add("IgnoredRoles",
            new ServerSettingsItem(SettingsItemType.RoleList, "A list of roles I will ignore commands from.",
                SettingsItemCategory.Core));
        _settings.Add("MentionResponseEnabled",
            new ServerSettingsItem(SettingsItemType.Boolean, "Whether I will respond to someone mentioning me.",
                SettingsItemCategory.Core));
        _settings.Add("MentionResponses",
            new ServerSettingsItem(SettingsItemType.StringList,
                "A list of responses I will send whenever someone mentions me.", SettingsItemCategory.Core));
        _settings.Add("MentionResponseCooldown",
            new ServerSettingsItem(SettingsItemType.Double,
                "How many seconds I should wait between responding to a mention", SettingsItemCategory.Core));

        // Mod settings
        _settings.Add("ModRole",
            new ServerSettingsItem(SettingsItemType.Role, "The role that I allow to execute sensitive commands.",
                SettingsItemCategory.Moderation));
        _settings.Add("ModChannel",
            new ServerSettingsItem(SettingsItemType.Channel,
                "The channel I will post raid notifications and template action logs in.",
                SettingsItemCategory.Moderation));
        _settings.Add("LogChannel",
            new ServerSettingsItem(SettingsItemType.Channel, "The channel I will post my own action logs in.",
                SettingsItemCategory.Moderation));

        // User based settings
        _settings.Add("MemberRole",
            new ServerSettingsItem(SettingsItemType.Role,
                ...
                SettingsItemCategory.User, true));
        _settings.Add("NewMemberRole",
            new ServerSettingsItem(SettingsItemType.Role,
                ...
                SettingsItemCategory.User, true));
        _settings.Add("NewMemberRoleDecay",
            new ServerSettingsItem(SettingsItemType.Double,
                "The amount of minutes I'll wait before removing `NewMemberRole` from a user.",
                SettingsItemCategory.User));


        // Filter settings
        _settings.Add("FilterEnabled",
            new ServerSettingsItem(SettingsItemType.Boolean,
                "Whether I will filter messages for words in the `FilteredWords` list.", SettingsItemCategory.Filter));
        _settings.Add("FilterMonitorEdits",
            new ServerSettingsItem(SettingsItemType.Boolean,
                "Whether I will refilter edited messages for words in the `FilteredWords` list.",
                SettingsItemCategory.Filter));
        _settings.Add("FilterIgnoredChannels",
            new ServerSettingsItem(SettingsItemType.ChannelList, "The list of channels I will not filter messages in.",
                SettingsItemCategory.Filter));
        _settings.Add("FilterBypassRoles",
            new ServerSettingsItem(SettingsItemType.RoleList,
                ...
                SettingsItemCategory.Filter));
        _settings.Add("FilteredWords",
            new ServerSettingsItem(SettingsItemType.StringListDictionary,
                "The map of the list of words I will filter. Each key is a separate filter category.",
                SettingsItemCategory.Filter));
        _settings.Add("FilterResponseDelete",
            new ServerSettingsItem(SettingsItemType.BooleanDictionary,
                "The map containing if I'll delete a message on filter violation depending on which filter category was violated.",
                SettingsItemCategory.Filter));
        _settings.Add("FilterResponseMessages",
            new ServerSettingsItem(SettingsItemType.StringDictionary,
                "The map of messages I will send on a filter violation depending on which filter category was violated.",
                SettingsItemCategory.Filter, true));
        _settings.Add("FilterResponseSilence",
            new ServerSettingsItem(SettingsItemType.BooleanDictionary,
                "The map containing if I'll silence a user on a filter violation depending on which filter category was violated.",
                SettingsItemCategory.Filter));

        // Pressure settings
        _settings.Add("SpamEnabled",
            new ServerSettingsItem(SettingsItemType.Boolean,
                "Whether I will process messages and apply pressure to users.", SettingsItemCategory.Spam));
        _settings.Add("SpamMonitorEdits",
            new ServerSettingsItem(SettingsItemType.Boolean,
                ...
                SettingsItemCategory.Spam));
        _settings.Add("SpamEditReprocessThreshold",
            new ServerSettingsItem(SettingsItemType.Integer,
        ...
        _settings.Add("SpamBypassRoles",
            new ServerSettingsItem(SettingsItemType.RoleList,
                ...
                SettingsItemCategory.Spam));
        _settings.Add("SpamIgnoredChannels",
            new ServerSettingsItem(SettingsItemType.ChannelList,
                "The channels I will not process pressure for. Best used for channels where spam is allowed.",
                SettingsItemCategory.Spam));
        _settings.Add("SpamBasePressure",
            new ServerSettingsItem(SettingsItemType.Double,
                "The base pressure given to a user when they send a message.", SettingsItemCategory.Spam));
        _settings.Add("SpamImagePressure",
            new ServerSettingsItem(SettingsItemType.Double,
                ...
                SettingsItemCategory.Spam));
        _settings.Add("SpamLengthPressure",
            new ServerSettingsItem(SettingsItemType.Double,
                "Additional pressure generated by each individual character in the message.",
                SettingsItemCategory.Spam));
        _settings.Add("SpamLinePressure",
            new ServerSettingsItem(SettingsItemType.Double,
                "Additional pressure generated by each newline in the message.", SettingsItemCategory.Spam));
        _settings.Add("SpamPingPressure",
            new ServerSettingsItem(SettingsItemType.Double,
                "Additional pressure generated by each ping in a message (non-unique pings are counted).",
                SettingsItemCategory.Spam));
        _settings.Add("SpamRepeatPressure",
            new ServerSettingsItem(SettingsItemType.Double,
                "Additional pressure generated by a message that is identical to the previous message sent (ignores case).",
                SettingsItemCategory.Spam));
        _settings.Add("SpamMaxPressure",
            new ServerSettingsItem(SettingsItemType.Double, "How much pressure a user can have before I silence them.",
                SettingsItemCategory.Spam));
        _settings.Add("SpamPressureDecay",
            new ServerSettingsItem(SettingsItemType.Double,
                "How long in seconds it takes for a user to lose `SpamBasePressure` from their pressure amount.",
                SettingsItemCategory.Spam));
        _settings.Add("SilenceTimeout",
            new ServerSettingsItem(SettingsItemType.Double,
                ...
                SettingsItemCategory.Spam, true));

        // Raid settings
        _settings.Add("RaidProtectionEnabled",
            new ServerSettingsItem(SettingsItemType.Boolean,
                ...
                SettingsItemCategory.Raid));
        _settings.Add("NormalVerificationLevel",
            new ServerSettingsItem(SettingsItemType.Integer,
                ...
                SettingsItemCategory.Raid, true));
        _settings.Add("RaidVerificationLevel",
            new ServerSettingsItem(SettingsItemType.Integer,
                ...
                SettingsItemCategory.Raid, true));
        _settings.Add("AutoSilenceNewJoins",
            new ServerSettingsItem(SettingsItemType.Boolean,
    ...
    public List<string> GetSettableConfigItems()
    {
        ...
        foreach (var key in _settings.Keys) settableConfigItems.Add(key);
