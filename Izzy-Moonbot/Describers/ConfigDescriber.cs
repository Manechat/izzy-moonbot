...
public class ConfigDescriber
{
    ...
    public ConfigDescriber()
    {
        ...
        _config.Add("SpamUnusualCharacterPressure",
            new ConfigItem(ConfigItemType.Double,
                "Additional pressure generated by each unusual character in a message. A character is considered 'unusual' if it is not in one of the following Unicode character classes: " +
